...
public class Thirteenth {
    ...
    public Thirteenth(int year, int month, String uploadPath) throws Exception {
        ...
        new SQLReader(uploadPath + "/queries", "13_1.txt").read();
        ...
        query = "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "13_2.txt").read();
