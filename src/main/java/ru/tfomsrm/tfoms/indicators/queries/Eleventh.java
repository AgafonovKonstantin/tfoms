...
public class Eleventh {
    ...
    public Eleventh(int year, int month, String uploadPath) throws Exception {
        ...
        new SQLReader(uploadPath + "/queries", "11_1.txt").read();
        ...
        query = "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "11_2.txt").read();
