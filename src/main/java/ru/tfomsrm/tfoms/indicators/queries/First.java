...
public class First {
    ...
    public First(int year, int month, String uploadPath) throws Exception {
        ...
        new SQLReader(uploadPath + "/queries", "1_1.txt").read();
        ...
        query = "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "1_2.txt").read();
        ...
        query =  "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "1_3.txt").read();

        ResultSet result_3 = statement.executeQuery(query);

        table = new Hashtable();

        while (result_3.next()) {
            String nam_mok = result_3.getString("nam_mok");
            int count = result_3.getInt("col");
