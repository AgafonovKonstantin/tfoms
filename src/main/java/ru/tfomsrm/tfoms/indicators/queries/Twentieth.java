...
public class Twentieth {
    ...
    public Twentieth(int year, int month, String uploadPath) throws Exception {
        ...
        new SQLReader(uploadPath + "/queries", "20_1.txt").read();
        ...
        query = "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "20_2.txt").read();
