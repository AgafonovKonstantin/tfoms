...
public class Tenth {
    ...
    public Tenth(int year, int month, String uploadPath) throws Exception {
        ...
        new SQLReader(uploadPath + "/queries", "10_1.txt").read();
        ...
        query = "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "10_2.txt").read();
