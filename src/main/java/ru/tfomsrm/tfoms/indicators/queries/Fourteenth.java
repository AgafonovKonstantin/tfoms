...
public class Fourteenth {
    ...
    public Fourteenth(int year, int month, String uploadPath) throws Exception {
        ...
        new SQLReader(uploadPath + "/queries", "14_1.txt").read();
        ...
        query = "declare @month int = " + month + "\n" +
                ...
                new SQLReader(uploadPath + "/queries", "14_2.txt").read();
